...
counts_path <- "C:/Users/Qiang/Desktop/SIAT/data/musWT_HD_stringtie_nobiascorrect_combined_est_counts.csv"
...
required_columns <- c("t_name", "stringtie_result_musHD_STR-1_cov", "stringtie_result_musHD_STR-2_cov", "stringtie_result_musHD_STR-3_cov", "stringtie_result_musWT_STR-1_cov", "stringtie_result_musWT_STR-2_cov", "stringtie_result_musWT_STR-3_cov")
...
# Select required columns explicitly using dplyr::select
selected_count <- dplyr::select(count_data, t_name,
                                `stringtie_result_musHD_STR-1_cov`,
                                `stringtie_result_musHD_STR-2_cov`,
                                `stringtie_result_musHD_STR-3_cov`,
                                `stringtie_result_musWT_STR-1_cov`,
                                `stringtie_result_musWT_STR-2_cov`,
                                `stringtie_result_musWT_STR-3_cov`)
...
rownames(count_matrix) <- selected_count$t_name  # Assuming 'Present_in_Transcripts' are the gene/feature identifiers
...
data <- data.frame(
  Sample = c("stringtie_result_musHD_STR-1_cov", "stringtie_result_musHD_STR-2_cov", "stringtie_result_musHD_STR-3_cov", "stringtie_result_musWT_STR-1_cov", "stringtie_result_musWT_STR-2_cov", "stringtie_result_musWT_STR-3_cov"),
...
ggplot(pcaData, aes(PC1, PC2, color = Type)) +
  ...
  ggtitle("PCA of musHD and musWT from StringTie")

# Output the PCA coordinates (PC1 and PC2) to a text file
output_file <- "C:/Users/Qiang/Desktop/SIAT/data/pca_coordinates_stringtie.txt"
