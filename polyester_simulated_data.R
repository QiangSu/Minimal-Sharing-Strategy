...
abundance_file <- "/home/data/qs/data/reference_isoform/99272N_results_file_GC.csv"  # Define the abundance file path here
...
fasta_info <- readDNAStringSet(reference_transcriptome)  # Correct function usage
...
output_dir <- "simulated_data_99272N"
